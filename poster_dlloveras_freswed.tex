...
\vskip -0.16cm
{\footnotesize\sf
Carrington maps of several DEMT and AWSoM products at $1.105\, {\rm R}_\odot$ for CR-2082.{\bf Left Panels:} electronic density, electronic temperature and radiative power.{\bf Right Panels:} the ratio between AWSoM and DEMT of those quantities.
}
}

\headerbox{Results for CR-2208}
...
\headerbox{Global Comparison as a Function of Height in Streamers}
{name=alturas,column=0,below=maps2,span=2}{
{\footnotesize\sf
\begin{center}
\azul{\hskip 3.5cm CR2082 \hfill CR2208 \hskip 3.5cm}
\vskip 0.01cm
{\includegraphics[width=0.37\textwidth]{Average_Radial_Profiles_Ne_awsom_vs_demt_H_cr2082_ratio_streamer.pdf}}
{\includegraphics[width=0.37\textwidth]{Average_Radial_Profiles_Ne_awsom_vs_demt_H_cr2208_ratio_streamer.pdf}}\\
{\includegraphics[width=0.37\textwidth]{Average_Radial_Profiles_Te_awsom_vs_demt_H_cr2082_ratio_streamer.pdf}}
{\includegraphics[width=0.37\textwidth]{Average_Radial_Profiles_Te_awsom_vs_demt_H_cr2208_ratio_streamer.pdf}}\\
{\includegraphics[width=0.37\textwidth]{Average_Radial_Profiles_Er_awsom_vs_demt_H_cr2082_ratio_streamer.pdf}}
{\includegraphics[width=0.37\textwidth]{Average_Radial_Profiles_Er_awsom_vs_demt_H_cr2208_ratio_streamer.pdf}}\\
\end{center}
\vskip -0.16cm
...
\headerbox{Radiative Flux in streamers}
{name=ajuste1,column=2,below=maps3,span=2}{
{\footnotesize\sf
\begin{center}
\azul{\hskip 3.5cm CR2082 \hfill CR2208 \hskip 3.0cm}
%\vskip 0.01cm
{\includegraphics[width=0.4\textwidth]{comparison_Er_awsom_vs_demt_H_cr2082_ratio_streamer_ratio_range1055-1250_Rsun.pdf}}
{\includegraphics[width=0.4\textwidth]{comparison_Er_awsom_vs_demt_H_cr2208_ratio_streamer_ratio_range1055-1250_Rsun.pdf}}\\
\end{center}
Histogram of the AWSoM-to-DEMT ratio of the radiative power, in the height range $1.05-1.26\,\rm{R}_{\odot}$.
}
}
\headerbox{Comments}
{name=comments,column=2,below=ajuste1,span=2}{
{\footnotesize\sf
\bu As in a previous analysis below $\sim 1.05 {\rm R_{SUN}}$ the electron temperatures of AWSoM are a factor $\sim 2$ smaller than those observed with DEMT, while the electron densities are a factor $\sim 2-5$ large. This lack of agreement is related to the AWSoM treatment of the extended Chromosphere/Corona transition.

\bu Above $\sim 1.05 {\rm R_{SUN}}$ AWSoM tends to under-estimate (in both Streamers and CHs) ${\rm N_e}$ and ${\rm T_e}$ by $\lessapprox\,20\%$

%\bu The structure of the streamer is dominated by down loops which are not modeled by AWSoM.

\bu Since Radiative power ${\rm E_r}\sim {\rm N_e}^2 {\rm LF}$ and the LF is similarly treated by both models (using same version of CHIANTI), the AWSoM-to-DEMT ratio of the radiative power closely matches that of the ${\rm N_e}^2$.
}
}

\headerbox{Next Steps}
{name=conclusions,column=2,below=comments,span=2}{
{\footnotesize\sf
\bu The DEMT electron density may require corrections due to the unknown [Fe] and the coronal irregularity factor. See the poster "Multi-Instrumental Tomography of the Solar Corona", by Frazin et al., in this same poster session.

\bu We will repeat the same type of analaysis for a rotation selected from the current solar minimum between Solar Cycles 24 and 25.

\bu A more detailed and precise analysis tracing the DEMT and AWSoM data along the magnetic lines will be carried out to validate AWSoM separately in specific coronal structures.
